...
MAX_DSTEER: float = float(np.deg2rad(45.0)) # 120, 180  # maximum steering speed [rad/s] (i.e. AckermannDrive.steering_angle_velocity)
...
#np.diag([0.1, 900.0])
#np.diag([0.1, 1000.0])
Qk = [50.0, 50.0, 5.5, 50.0] # 10
Qfk = [50.0, 50.0, 5.5, 50.0]
    ...
    return LaunchDescription([
        Node(
            ...
            parameters=[{
                ...
                "Qk": Qk,
                "Qfk": Qfk,
                'map': '/home/weins/sim_ws/csv/traj_race_monza_v2.csv', # /home/weins/sim_ws/csv/shortest_path-11-09-2024_18-47.csv '/home/weins/sim_ws/csv/traj_race_monza_v2.csv',
                "fast_start": True,
            }],
            arguments=[
                "monza",
